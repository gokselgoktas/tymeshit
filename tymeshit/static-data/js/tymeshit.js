...
function getTimeAsUnicodeEmoji() {
    ...
    let halfAnHourOffset = Math.round(date.getMinutes() * 0.033333333333333);

    hourOffset += Math.max(0, halfAnHourOffset - 1);
    halfAnHourOffset %= 2;

    const codePoint = oneOClock + hourOffset + 12 * halfAnHourOffset;
